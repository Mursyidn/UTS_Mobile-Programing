package com.example.mursid.uts_mobpro;
...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Pil = new String[] {"Martabak Special", "Martabak Blueberry", "Martabak Coco Crunch", "Martabak Greentea", "Martabak Keju"};
        Gbr = new String[] {
                Integer.toString(R.drawable.special),
                Integer.toString(R.drawable.blueberry),
                Integer.toString(R.drawable.cococrucnh),
                Integer.toString(R.drawable.greentea),
                Integer.toString(R.drawable.keju),
